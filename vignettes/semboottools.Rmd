...
gg_hist_qq_boot(fit, "ab", standardized = FALSE)
# For estimates in standardized solution,
gg_hist_qq_boot(fit, "ab", standardized = TRUE)
```
...
gg_scatter_boot(fit, c("a", "b", "ab"), standardized = TRUE)
# unstandardized solution
gg_scatter_boot(fit, c("a", "b", "ab"), standardized = FALSE)
```
